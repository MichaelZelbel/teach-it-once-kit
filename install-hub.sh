...
#
# It also installs what is missing underneath (Git, Node.js, Claude Code) and
...
ENGINE="https://raw.githubusercontent.com/MichaelZelbel/kit-bootstrap/v1/setup-hub.sh"
